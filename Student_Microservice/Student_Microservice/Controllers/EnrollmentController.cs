...
namespace Student_Microservice.Controllers
{
    ...
    public class EnrollmentController : ControllerBase
    {
        ...
        [HttpGet("EnrolledExams")]
        public async Task<ActionResult<IEnumerable<Enrollment>>> GetEnrolledExams(string studentEmail)
        {
            var enrolledExams = await _context.Enrollments
                .Include(e => e.Exam) // Include the Exam navigation property
    ...
    public async Task<ActionResult<Enrollment>> PostEnrollment(Enrollment enrollment)
    {
        if (_context.Enrollments == null)
        {
            return Problem("Entity set 'StudentDbContext.Enrollments'  is null.");
        }
